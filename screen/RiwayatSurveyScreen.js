...
export default function RiwayatSurveyScreen(props) {
  return (
    <View style={{flex:1,backgroundColor:"#f0f5fb"}}>
        ...
        <View style={{backgroundColor:"#0cca88",flexDirection:"row",paddingHorizontal:EStyleSheet.value("15rem"),height:EStyleSheet.value("50rem")}}>
            ...
            <View style={{flex:1,justifyContent:"center",alignItems:"center"}}>
                <Text style={{color:"white",fontFamily:"NunitoBold"}}>Riwayat Survey</Text>
            </View>
        ...
        <View style={{flex:1}}>
             ...
             renderItem={()=>{
                 return (
                     <View style={{backgroundColor:"white",padding:EStyleSheet.value("20rem"),paddingHorizontal:EStyleSheet.value("15rem"),borderRadius:EStyleSheet.value("5rem"),...shadow,marginHorizontal:EStyleSheet.value("15rem"),marginBottom:EStyleSheet.value("15rem")}}>
